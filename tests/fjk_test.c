...
MU_TEST(encrypt_6) { mu_assert(strncmp(fjk_encrypt("123456", 6), "e31642", 6) == 0, "encryption of '123456' is not equal to '531642'"); }
MU_TEST(encrypt_7) { mu_assert(strncmp(fjk_encrypt("1234567", 7), "e531642", 7) == 0, "encryption of '1234567' is not equal to '7531642'"); }
MU_TEST(encrypt_8) { mu_assert(strncmp(fjk_encrypt("12345678", 8), "e7531642", 8) == 0, "encryption of '12345678' is not equal to '87531642'"); }
MU_TEST(encrypt_9) { mu_assert(strncmp(fjk_encrypt("123456789", 9), "e41852963", 9) == 0, "encryption of '123456789' is not equal to '741852963'"); }
